...
<body <?php body_class(); ?>>
    <header class="site-header">
        <div class="container">
            <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>WordPress</strong> Template</a></h1>
            ...
            <div class="site-header__menu group">
                ...
                <div class="site-header__util">
                    ...
                    <span class="js-search-trigger search-trigger"><i class="fa fa-search" aria-hidden="true"></i></span>
                </div>
            </div>
        </div>
    </header>